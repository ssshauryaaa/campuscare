...
export const TYPE_LABELS: Record<AttackType, string> = {
  ...
  idor_feedback:   "IDOR — FEEDBACK",
  xss_feedback:    "XSS — FEEDBACK RESP",
...
export const TYPE_COLORS: Record<AttackType, { text: string; bg: string; border: string }> = {
  ...
  idor_feedback:   { text: "#0369a1", bg: "#f0f9ff", border: "#7dd3fc" },
  xss_feedback:    { text: "#c2410c", bg: "#fff7ed", border: "#fdba74" },
